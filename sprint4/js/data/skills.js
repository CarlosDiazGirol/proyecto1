const skills = [
  ...
  },
  {
    ...
    state: "dominada",
    level: "intermedio-avanzado",
    description: "Componentes funcionales, hooks, estado, props y renderizado condicional.",
    tags: ["Hooks", "State", "Props", "SPA"]
  },
  {
    name: "Node.js",
    ...
    state: "dominada",
    level: "intermedio",
    description: "Backend con JavaScript, manejo de servidores y APIs REST.",
    tags: ["Backend", "APIs", "HTTP"]
  },
  {
    name: "Express",
    ...
    state: "dominada",
    level: "intermedio",
    description: "Framework minimalista para crear APIs y middleware en Node.js.",
    tags: ["APIs", "Middleware", "Routing"]
  },
  {
    name: "SQL",
    ...
    state: "dominada",
    level: "intermedio",
    description: "Consultas SQL, relaciones, joins y modelado de bases de datos.",
    tags: ["Queries", "Joins", "Relational DB"]
  },
  {
    name: "MongoDB",
  ...
  },
  {
    ...
    state: "dominada",
    level: "intermedio",
    description: "Framework moderno para sitios rápidos con enfoque en rendimiento.",
    tags: ["Islands", "Static Sites", "Performance"]
  },
  
  {
    ...
    state: "en progreso",
    level: "intermedio",
    description: "Tipado estático para JavaScript y mayor mantenibilidad.",
  ...
  },
  {
    ...
    state: "dominada",
    level: "intermedio",
    description: "Herramienta de build rápida para proyectos frontend.",
  ...
  },
  {
    ...
    state: "dominada",
    level: "intermedio",
    description: "Diseño UI y prototipado para aplicaciones.",
